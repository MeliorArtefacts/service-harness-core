  ...
  public void error(
    ...
    final Object... messageParts){
        ...
        if (isErrorEnabled() == true){
            ...
            if (messagePart instanceof java.lang.Throwable){
                logger.write(LogLevel.ERROR, loggerName, methodName, Arrays.copyOf(messageParts, messageParts.length - 1), (java.lang.Throwable) messagePart);
      }
      else{
