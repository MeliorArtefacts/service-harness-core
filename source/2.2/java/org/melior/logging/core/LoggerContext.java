...
import org.melior.logging.appender.Configuration;
 ...
 * configuration and instanciates the relevant internal appenders.  It
...
public class LoggerContext{
  ...
  public LoggerContext(){
    ...
    try{
            normalTraceAppender = new ConsoleAppender(Stream.TRACE, null);
      errorTraceAppender = new ConsoleAppender(Stream.TRACE_ERROR, null);
      normalTransactionAppender = new ConsoleAppender(Stream.TRANSACTION, null);
      errorTransactionAppender = new ConsoleAppender(Stream.TRANSACTION_ERROR, null);
    }
