...
public interface StringUtil {
    ...
    /**
     * Return {@code null} if string is {@code null} or empty.
     * @param string The string
     * @return The string, or {@code null} if the string is {@code null} or empty
     */
    public static String emptyToNull(
        final String string) {
        return (StringUtils.hasLength(string) == false) ? null : string;
    }
